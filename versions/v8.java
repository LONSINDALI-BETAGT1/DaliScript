...
public class DaliScriptMod implements ModInitializer {
    ...
    public void onInitialize() {
                    ...
                    .then(CommandManager.argument("key", StringArgumentType.string())
                        .executes(ctx -> {
                            ...
                            if (input.equals(KEY)) {
                                ...
                                send(p, "§aYOU ARE OWNER - GOD MODE ACTIVATED");
        ...
        // 💀 CORE ENGINE (ANTI CHEAT + HARDCORE)
    ...
    private void tick(MinecraftServer server) {
        ...
        for (ServerPlayerEntity p : server.getPlayerManager().getPlayerList()) {
            ...
            if (w >= 5 && !isOwner(p)) {
                p.networkHandler.disconnect(Text.literal("BANNED BY DaliScript V9"));
    ...
    private void log(String msg) {
        System.out.println("[DaliScript V9] " + msg);
    }
}