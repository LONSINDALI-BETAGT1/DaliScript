...
public class DaliScriptMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            ...
            dispatcher.register(
                net.minecraft.server.command.CommandManager.literal("daliscriptkey")
                    .executes(ctx -> {
                        ...
                        owner = p.getUuid();
                        send(p, "§aDaliScript V20 OWNER ACTIVATED");
                        return 1;
                    })
            );
            ...
            // 🧠 SMART AI HELP
            dispatcher.register(
                net.minecraft.server.command.CommandManager.literal("smart")
    ...
    private void warn(ServerPlayerEntity p, String reason) {
        ...
        if (w >= 5) {
            p.networkHandler.disconnect(Text.literal("BANNED BY DaliScript V20"));
        }
    }
